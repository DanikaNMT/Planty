...
public class CreatePlantCommandValidatorTests
{
    ...
    {
        var command = new CreatePlantCommand(string.Empty, null, null, null, null, Guid.NewGuid());
    ...
    {
        var command = new CreatePlantCommand("Name", null, null, null, null, Guid.NewGuid());
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreatePlantCommand("Name", new string('a', 101), null, null, null, Guid.NewGuid());
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreatePlantCommand("Name", null, null, 0, null, Guid.NewGuid());
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreatePlantCommand("Name", null, null, 366, null, Guid.NewGuid());
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.WateringIntervalDays);
    }
    ...
    {
        var command = new CreatePlantCommand("Valid Name", null, null, null, null, Guid.NewGuid());
        var result = _validator.TestValidate(command);
        result.ShouldNotHaveAnyValidationErrors();
    }
}
